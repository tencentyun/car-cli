...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=DescribeCloudPhoneBatchTasks" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：DescribeCloudPhoneBatchTasks。 |
| Version | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：2019-11-18。 |
| Region | 否 | String | [公共参数](/document/api/1162/40732)，此参数为可选参数。 |
| TaskIds.N | 是 | Array of String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>任务ID列表，最大1000<br/>示例值：[xxx] |
...
### 示例1 DescribeCloudPhoneBatchTasks
...
X-TC-Action: DescribeCloudPhoneBatchTasks
<公共请求参数>
...
{
    "Response": {
        "RequestId": "53df31b8-36f4-412e-beff-9d42c511c60b",
        "Tasks": [
            {
