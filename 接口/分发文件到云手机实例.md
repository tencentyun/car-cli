...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=DistributeFileToCloudPhoneInstances" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：DistributeFileToCloudPhoneInstances。 |
...
| FileId | 是 | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件ID，通过文件上传后获取 参考：文件管理-新 增文件<br/>示例值：11 |
| Path | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>实例文件保存路径<br/>示例值：/data/local/1.xx |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| DistributeFileInfos | Array of [CloudPhoneDistributeFileInfo](/document/api/1162/40743#CloudPhoneDistributeFileInfo) | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件分发信息列表|
...
X-TC-Action: DistributeFileToCloudPhoneInstances
<公共请求参数>
...
```json
{
    "Response": {
        ...
        "RequestId": "2c187856-5422-454d-b3aa-fda5e56bcdef"
    }
}
```
