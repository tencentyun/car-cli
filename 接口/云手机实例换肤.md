...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=ModifyCloudPhoneInstancesSkin" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：ModifyCloudPhoneInstancesSkin。 |
...
| Brand | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>品牌<br/>示例值：HUAWEI |
| Model | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>型号 <br/>示例值：HUAWEI META 60 |
...
X-TC-Action: ModifyCloudPhoneInstancesSkin
<公共请求参数>
...
{
    "Response": {
        "RequestId": "11a0c297-c80b-4414-92cd-9bf5521d25fe",
        "Tasks": [
            {
