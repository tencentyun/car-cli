...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=CreateCloudPhoneFile" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：CreateCloudPhoneFile。 |
| Version | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：2019-11-18。 |
| Region | 否 | String | [公共参数](/document/api/1162/40732)，此参数为可选参数。 |
| URL | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件下载地址<br/>示例值：www.test.com |
| MD5 | 否 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件MD5<br/>示例值：e10adc3949ba59abbe56e057f20f883e |
| FileName | 否 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件名称<br/>示例值：test |
...
| FileMessage | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>文件状态说明<br/>示例值：success|
...
X-TC-Action: CreateCloudPhoneFile
<公共请求参数>
