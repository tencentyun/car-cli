...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=RenewCloudPhoneMultipleStreamSession" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：RenewCloudPhoneMultipleStreamSession。 |
...
| RenewalHours | 是 | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>续期时间，单位小时<br/>示例值：1 |
...
X-TC-Action: RenewCloudPhoneMultipleStreamSession
<公共请求参数>

{
    "SessionId": "1327249908628787200",
    "RenewalHours": 120
}
```
...
{
    "Response": {
        "RequestId": "d142f182-c792-4cbd-927b-009e0904749b"
    }
}
```
