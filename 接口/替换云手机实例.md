...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=ReplaceCloudPhoneInstance" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：ReplaceCloudPhoneInstance。 |
| Version | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：2019-11-18。 |
| Region | 否 | String | [公共参数](/document/api/1162/40732)，此参数为可选参数。 |
| SourceInstanceId | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>源实例 ID<br/>示例值：RK_61ae5f48-b3f6 |
| TargetInstanceId | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>目标实例 ID<br/>示例值：RK_d9bdf286-8bf2 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| SourceInstanceId | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>源实例 ID<br/>示例值：RK_61ae5f48-b3f6|
| TargetInstanceId | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>目标实例 ID<br/>示例值：RK_d9bdf286-8bf2|
| TaskId | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>主任务 ID<br/>示例值：545|
| SubTaskId | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>子任务 ID<br/>示例值：728|
...
X-TC-Action: ReplaceCloudPhoneInstance
<公共请求参数>

{
    "SourceInstanceId": "rs-abc123",
    "TargetInstanceId": "rs-abc456"
}
```
