...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=DescribeCloudPhoneInstanceADBAddr" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：DescribeCloudPhoneInstanceADBAddr。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| IP | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>ADB IP <br/>示例值：14.12.15.26|
| Port | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>ADB 端口<br/>示例值：3265|
| RequestId | String | 唯一请求 ID，由服务端生成，每次请求都会返回（若请求因其他原因未能抵达服务端，则该次请求不会获得 RequestId）。定位问题时需要提供该次请求的 RequestId。|

## 4. 示例

### 示例1 查询云手机实例 ADB 连接地址
...
X-TC-Action: DescribeCloudPhoneInstanceADBAddr
<公共请求参数>
...
```json
{
    "Response": {
        "IP": "115.227.9.140",
        "Port": 10382,
        "RequestId": "509c6673-2b32-4373-923a-65679030f5f9"
    }
}
```
