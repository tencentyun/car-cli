...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=SelectCloudPhoneMultipleStreamSessionSlaves" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：SelectCloudPhoneMultipleStreamSessionSlaves。 |
...
X-TC-Action: SelectCloudPhoneMultipleStreamSessionSlaves
<公共请求参数>
...
{
    "Response": {
        "RequestId": "5db82a3b-5430-4cb0-bd55-0c3602106290"
    }
}
```
