...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=DescribeCloudPhoneInstanceImages" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：DescribeCloudPhoneInstanceImages。 |
| Version | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：2019-11-18。 |
| Region | 否 | String | [公共参数](/document/api/1162/40732)，此参数为可选参数。 |
| ImageId | 否 | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>镜像 ID<br/>示例值：1 |
| CardType | 否 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>适应板卡类型 QS865、 RK3588_256_A、 RK3588_256_B、 RK3588_128_A、 QS8550<br/>示例值：RK3588_128_A |
| Vendor | 否 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>供应商编码<br/>示例值：RCSX |
...
| Images | Array of [CloudPhoneInstanceImage](/document/api/1162/40743#CloudPhoneInstanceImage) | <strong><font color="blue">此参数仅产品内部展示。</font></strong>镜像列表|
...
X-TC-Action: DescribeCloudPhoneInstanceImages
<公共请求参数>
