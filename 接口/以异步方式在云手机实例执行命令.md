...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=ExecuteCommandAsyncOnCloudPhoneInstances" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：ExecuteCommandAsyncOnCloudPhoneInstances。 |
...
| Command | 是 | String | <strong><font color="blue">此参数仅产品内部展示。</font></strong>命令<br/>示例值：ls |
| Timeout | 否 | Integer | <strong><font color="blue">此参数仅产品内部展示。</font></strong>超时时间(秒）， 默认10<br/>示例值：10 |

## 3. 输出参数

| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| Tasks | Array of [CloudPhoneTask](/document/api/1162/40743#CloudPhoneTask) | <strong><font color="blue">此参数仅产品内部展示。</font></strong>任务信息列表，可以根据里面的任务 ID 轮询任务结果|
...
X-TC-Action: ExecuteCommandAsyncOnCloudPhoneInstances
<公共请求参数>

{
    "InstanceIds": [
        "RK8S37P1402445262_68beccf1-7362-4936-9948-aa01574de1a8",
        "RK8S37P1402445262_e6366417-3c2c-4014-a757-b7eb1a2e2b22"
    ],
    "Command": "ls",
    "Timeout": 5
}
...
{
    "Response": {
        "RequestId": "c2223341-56e6-4d78-b1e5-e67aef8dd734",
        "Tasks": [
            {
                "ResourceId": "RK8S37P1402445262_e6366417-3c2c-4014-a757-b7eb1a2e2b22",
                "SubTaskId": 1912,
                "TaskId": 1587
            },
            {
                "ResourceId": "RK8S37P1402445262_68beccf1-7362-4936-9948-aa01574de1a8",
                "SubTaskId": 1913,
                "TaskId": 1587
            }
        ]
