...
<div class="rno-api-explorer">
    <div class="rno-api-explorer-inner">
        <div class="rno-api-explorer-hd">
            ...
            <a href="https://console.cloud.tencent.com/api/explorer?Product=gs&Version=2019-11-18&Action=DescribeCloudPhoneInstanceModels" class="rno-api-explorer-btn" hotrep="doc.api.explorerbtn"><i class="rno-icon-explorer"></i>点击调试</a>
        </div>
...
| 参数名称 | 必选 | 类型 | 描述 |
|---------|---------|---------|---------|
| Action | 是 | String | [公共参数](/document/api/1162/40732)，本接口取值：DescribeCloudPhoneInstanceModels。 |
...
| 参数名称 | 类型 | 描述 |
|---------|---------|---------|
| MachineModels | Array of [CloudPhoneInstanceModel](/document/api/1162/40743#CloudPhoneInstanceModel) | <strong><font color="blue">此参数仅产品内部展示。</font></strong>机型列表|
...
X-TC-Action: DescribeCloudPhoneInstanceModels
<公共请求参数>
